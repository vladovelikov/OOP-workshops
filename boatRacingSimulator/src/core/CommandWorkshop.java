...
public class CommandWorkshop implements CommandFactory {
    ...
    public CommandWorkshop(EngineFactory engineFactory, BoatFactory boatFactory, Repository<Engine> engineRepository,
                           Repository<Boat> boatRepository, RaceManager raceManager) {
    ...
    public Command produce(String type) {
        ...
        if (type.equals("CreateBoatEngine")) {
            command = new CreateBoatEngine(this.engineFactory, this.engineRepository);
